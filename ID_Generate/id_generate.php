    ...
    <div class="form">
        <div class="form-countainer">
            <div class="form-line1">
                <div class="form-left">地区</div><input type="text" class="input-bar" name="areaInput"/><div class="lookup"><a href="ID_Generate/lookup.php">查询</a></div>
            </div>
            <div class="form-line1">
                <div class="form-left">生日</div><?php include 'date-select.php'?>
            </div>
            <div class="form-line1">
                <div class="form-left">性别</div><select name="genderInput" class="select">
                    <option value="male" name="male">男</option>
                    <option value="female" name="female">女</option>
                </select>
            </div>
            <div class="form-line1">
                <div class="form-order">在您当地您是当时第</div><input type="num" class="input-bar" name="orderInput"/><div class="form-order">个出生的</div>
            </div>
        </div>
            <div class="generate">
