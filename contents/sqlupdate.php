    ...
    <div class="form">
        <div class="form-countainer">
            <div class="form-line1">
                <div class="form-title">地区:<?php echo $row[1]; ?></div><input type="text" class="input-bar"
                    name="areaInput" value="" />
                <div class="lookup"><a href="ID_Generate/lookup.php">查询</a></div>
            </div>
            <div class="form-line1">
                <div class="form-title">生日:<?php echo $row[2].'年'.$row[3].'月'.$row[4].'日'; ?></div>
                <?php include '../ID_Generate/date-select.php'?>
            </div>
            <div class="form-line1">
                <div class="form-title">性别:<?php if($row[5]=='female'){echo '女';}else{echo '男';} ?></div><select
                    name="genderInput" class="select">
