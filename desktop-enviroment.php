    ...
    <div class="form" style="width:480px;transform:translateX(3px)">
        <div class="form-countainer">
            <div class="form-line1">
                <div class="form-title">地区<span style="color:#f00;font-size:1.25rem;">*</span></div><input type="text" class="input-bar" name="areaInput"/><div class="lookup"><a href="ID_Generate/lookup.php">查询</a></div>
            </div>
            <div class="form-line1">
                <div class="form-title">生日<span style="color:#f00;font-size:1.25rem;">*</span></div><?php include '/ID_Generate/date-select.php'?>
            </div>
            <div class="form-line1">
                <div class="form-title">性别<span style="color:#f00;font-size:1.25rem;">*</span></div><select name="genderInput" class="select">
            ...
            <div class="generate">
				...
				<div id="right">
                    ...
                    <p class="mark">输入一些必要的基本信息(<span style="color:#f00;font-size:1.25rem;">*</span>为必填)，点击生成按钮即可生成一串身份证号码</p>
